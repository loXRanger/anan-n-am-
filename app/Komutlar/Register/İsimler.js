...
message.channel.send(stiprusembed.setDescription(`${uye} İsimli Kullanıcı Sunucuya \`${kayıtsayısı}\` Kere Kayıt Olmuş.
...
exports.help = {
  name: 'isimler',
  description: 'Geçmiş kayıt listesini gösterir. / Stiprus was here',
  usage: 'isimler'
};
...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(stiprusembed.setDescription(`**Bu Yetkiyi Kullanabilmen İçin \`Yönetici\` Yetkisine Sahip Olmalısın.**`)).then(x => x.delete({timeout: Config.Embed.Timeout}));
...
exports.help = {
  name: 'sil',
  description: 'Belirtilen miktarda mesajı siler / Stiprus was here',
  usage: 'sil'
};